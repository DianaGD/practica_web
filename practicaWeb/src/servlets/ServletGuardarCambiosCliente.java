...
public class ServletGuardarCambiosCliente extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Cliente cliente = new Cliente(nombre, calle, numeracion, codigo_postal, poblacion, telefono, email, particular_empresa);
		cliente.setId(Integer.parseInt(id));
		
		ClientesDAO clientesDAO = new ClientesDAOImpl();
		clientesDAO.guardarCambiosClientes(cliente);
